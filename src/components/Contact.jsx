        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 bg-[#111111]/50 border border-white/5 p-8 md:p-12 clip-card">
          ...
          >
            ...
            <form className="space-y-6 flex-1" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                className="w-full flex justify-center items-center gap-3 bg-cyan-600 hover:bg-cyan-500 text-black font-bold uppercase tracking-widest text-[0.85rem] py-4 shadow-[0_0_15px_rgba(34,211,238,0.2)] transition-all clip-button cursor-pointer"
              >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="flex flex-col justify-center space-y-6 lg:pl-12 lg:border-l border-white/5 mt-10 lg:mt-0"
          >
             <p className="font-sans text-gray-400 mb-2 max-w-sm">
              Let's build something amazing together. Feel free to reach out for software engineering roles, full-stack projects, or collaborations.
            </p>

            <a href="tel:+918484881414" className="card-tech clip-card p-5 flex items-center gap-5 group cursor-pointer border-transparent bg-[#0a0a0a]">
              ...
              <div>
                <h4 className="font-heading text-base font-bold text-[#f0f0f0] group-hover:text-cyan-400 transition-colors">Phone</h4>
                <div className="font-mono text-xs text-cyan-300 tracking-wider">+91 8484881414</div>
              </div>
            </a>

            <a href="mailto:samadhanade056@gmail.com" className="card-tech clip-card p-5 flex items-center gap-5 group cursor-pointer border-transparent bg-[#0a0a0a]">
              <div className="w-12 h-12 bg-[#111111] border border-white/5 text-cyan-400 flex items-center justify-center group-hover:border-cyan-500 transition-colors clip-button">
                <Mail size={20} />
              </div>
              <div>
                <h4 className="font-heading text-base font-bold text-[#f0f0f0] group-hover:text-cyan-400 transition-colors">Email</h4>
                <div className="font-mono text-xs text-gray-400 tracking-wider">samadhanade056@gmail.com</div>
              </div>
            </a>
            
            <a href="https://linkedin.com/in/samadhanade" target="_blank" rel="noopener noreferrer" className="card-tech clip-card p-5 flex items-center gap-5 group cursor-pointer border-transparent bg-[#0a0a0a]">
              ...
              <div>
                <h4 className="font-heading text-base font-bold text-[#f0f0f0] group-hover:text-blue-400 transition-colors">LinkedIn</h4>
                <div className="font-mono text-xs text-gray-400 tracking-wider">linkedin.com/in/samadhanade</div>
              </div>
            </a>
            
            <a href="https://github.com/samadhanade056-gif" target="_blank" rel="noopener noreferrer" className="card-tech clip-card p-5 flex items-center gap-5 group cursor-pointer border-transparent bg-[#0a0a0a]">
              ...
              <div>
                <h4 className="font-heading text-base font-bold text-[#f0f0f0] group-hover:text-purple-400 transition-colors">GitHub</h4>
                <div className="font-mono text-xs text-gray-400 tracking-wider">github.com/samadhanade056-gif</div>
              </div>
            </a>
          </motion.div>
