...
const Hero = () => {
  ...
  const titles = ["Full Stack MERN Developer", "Frontend & Backend Engineer", "Web Developer"];
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h2 className="font-mono text-cyan-400 text-[0.65rem] md:text-xs tracking-[0.4em] uppercase mb-4 block">
              <span className="text-gray-600 mr-2">{"//"}</span> Welcome to my portfolio
            </h2>
            ...
            <div className="h-10 mb-6 flex justify-center lg:justify-start overflow-hidden">
              <motion.h3 
                ...
                className="font-mono text-xl md:text-2xl text-cyan-300 font-semibold"
              >
                &gt; {titles[titleIndex]}_
              </motion.h3>
            </div>

            <p className="font-sans text-gray-300 text-base md:text-lg mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Electronics & Telecommunication Engineering student skilled in React.js, Node.js, Express.js, and MongoDB with a focus on modern full-stack web applications and clean UI/UX design.
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <a 
                href="#resume"
                className="clip-button bg-purple-600 hover:bg-purple-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] text-white px-8 py-3.5 font-bold tracking-widest text-[0.85rem] uppercase transition-all duration-300 transform hover:-translate-y-1"
              >
                Resume ↓
              </a>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              {/* Image Frame */}
              <div className="absolute inset-8 bg-[#161616] border border-white/10 rounded-full overflow-hidden group shadow-[0_0_30px_rgba(34,211,238,0.2)]">
                 <img 
                  src="/profile.jpg" 
                  alt="Samadhan Ade" 
