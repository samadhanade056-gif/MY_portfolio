      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="font-mono text-[0.65rem] uppercase tracking-[0.3em] text-gray-500">
              Electronics & Telecom Engineer // Full Stack MERN Developer
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <a href="https://linkedin.com/in/samadhanade" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#111111] border border-white/5 flex items-center justify-center text-gray-400 hover:text-blue-400 hover:border-blue-400 clip-button transition-all transform hover:-translate-y-1">
              <Linkedin size={18} />
            </a>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs font-mono text-gray-600 uppercase tracking-widest">
          ...
          <p className="mt-4 md:mt-0 flex gap-4">
            ...
            <span className="hover:text-cyan-500 cursor-pointer transition-colors">NODE.JS</span>
            <span className="hover:text-cyan-500 cursor-pointer transition-colors">MONGODB</span>
          </p>
        </div>
      </div>
    </footer>
