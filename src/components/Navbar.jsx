...
const Navbar = () => {
  ...
  const navLinks = ['Home', 'About', 'Skills', 'Projects', 'Experience', 'Resume', 'Contact'];
          ...
          >
            <div className="flex flex-col items-start px-6 py-6 space-y-5">
              ...
              <a
                ...
                className="w-full text-center mt-2 font-mono text-[0.8rem] text-cyan-400 border border-cyan-400/30 px-4 py-3 clip-button hover:bg-cyan-500/10 transition-all uppercase tracking-widest"
              >
                Resume ↓
              </a>
            </div>
